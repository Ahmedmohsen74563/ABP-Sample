...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p a3ef50bd-08a0-474f-9e05-1a7565566200
```

> `a3ef50bd-08a0-474f-9e05-1a7565566200` is the password of the certificate, you can change it to any password you want.
...
The application needs a database. Run the following command in the [Acme.BookStore](./Acme.BookStore) project directory to migrate the database and seed the initial data. This step is automatically done when you create a new solution, if you didn't especially disable it.
